      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <div class="pull-right">
            <a href="/admin/logout" style="color: white; background-color: inherit; font-size: 2rem; padding: 3rem;">Sair</a>
          </div>
        </ul>
      </div>
    </nav>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/products"><i class="fa fa-list"></i> <span>Produtos</span></a></li>
